...
f=open(r'C:\\Users\\MINUS\\Desktop\\work\\weibo_reaseach\\posts.txt','rb')
post_content=f.read()
f.close()
...
for d in post_con:
	...
	'''
	if comm_page!=0:
		os.system('python C:\\Users\\MINUS\\Desktop\\work\\weibo_reaseach\\repost.py %s %d' %(post_id,comm_page))
	'''	
	os.system('python C:\\Users\\MINUS\\Desktop\\work\\weibo_reaseach\\user_homepage.py %s' % main_usr_url)
	time.sleep(5)
